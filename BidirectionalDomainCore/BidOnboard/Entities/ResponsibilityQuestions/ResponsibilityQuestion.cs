...
public class ResponsibilityQuestion : BaseAuditableEntity
{
    ...
    public ResponsibilityQuestion? ParentQuestion { get; set; }
    ...
    public ICollection<ResponsibilityQuestionUserGroupMapper> ResponsibilityQuestionUserGroupMapper { get; set; } = new List<ResponsibilityQuestionUserGroupMapper>();
